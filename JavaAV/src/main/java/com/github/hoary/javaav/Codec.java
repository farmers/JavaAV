...
/**
 * {@code Codecs} are usually used by encoders and decoders. To create a
 * {@code Codec} use the {@link #getEncoderById(CodecID)} or
 * {@link #getEncoderByName(String)}, for decoder respectively.
 * 
 * @author Alex Andres
 */
public class Codec {
    ...
    /*
     * The following methods must not be exposed outside the package scope,
     * since they use FFmpeg classes directly.
     */
    ...
    /**
     * Initializes the {@code Codec} with a dictionary that may contain specific
     * codec parameters and a previously created codec context.
     * 
     * @param avDictionary dictionary with codec parameters.
    ...
    public static String[] getInstalledCodecs() {
        ...
        while ((codec = av_codec_next(codec)) != null) {
            ...
            String longName = "";
            if (codec.long_name() != null && codec.long_name().getString() != null)
                longName = codec.long_name().getString();
    ...
    /**
     * Get all supported sample formats by this {@code Codec}. If this
     * {@code Codec} is not an audio codec, then {@code null} is returned.
     * 
    ...
    /**
     * Get all supported sample rates by this {@code Codec}. If this
     * {@code Codec} is not an audio codec, then {@code null} is returned. The
     * sample rates are ordered in ascending order.
     * 
    ...
    /**
     * Get all supported frame rates by this {@code Codec}. If this
     * {@code Codec} is not a video codec, then {@code null} is returned. The
     * frame rates are ordered in ascending order.
     * 
    ...
    /**
     * Get all supported channel layouts by this {@code Codec}. If this
     * {@code Codec} is not an audio codec, then {@code null} is returned.
     * 
    ...
    /**
     * Get all supported pixel formats by this {@code Codec}. If this
     * {@code Codec} is not a video codec, then {@code null} is returned. The
     * pixel formats are ordered in ascending order.
     * 
