...
/**
 * An {@code AudioFrame} contains audio samples with a specific
 * {@code AudioFormat} that describes the characteristics of the samples.
 * Depending on how many channels the audio of this frame has, each channel can
 * be accessed with {@code getPlane()}.
 * 
 * @author Alex Andres
 */
public class AudioFrame extends MediaFrame {
    ...
    /**
     * Creates a new {@code AudioFrame} with descriptive format and allocates
     * memory for the specified amount of samples.
     * 
